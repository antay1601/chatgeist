...
CREDENTIALS_FILE=/home/node/.claude/.credentials.json /usr/local/bin/refresh_token.sh || echo "[entrypoint] Warning: Initial token refresh failed (may need valid credentials)"
