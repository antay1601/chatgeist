...
└── skills/
    ...
    ├── search.md           # Поиск и fact-checking
    └── top.md              # Топ заведений, сервисов, продуктов
```
...
| `search` | найди, поиск, где упоминается, кто писал про | Поиск и fact-checking |
| `top` | топ, рейтинг, лучшие, популярные | Топ заведений, сервисов, продуктов по мнениям чата |
...
| "Кто писал про аренду квартиры" | search |
| "Лучшие кафе" | top |
| "Топ ресторанов для работы" | top |
| "Рейтинг банков" | top |
...
### 3. Обновить README (опционально)

Добавьте описание в таблицу "Доступные Skills" в этом файле.
...
SKILLS = {
    ...
    "top": {
        "triggers": ["топ", "рейтинг", "лучшие", "популярные"],
        "file": "skills/top.md"
    }
}
```
